          ...
          <Alert variant="warning" className="mt-2">
            ...
            <ul>
              ...
              <li>
                ...
                ternyata di hari H gak bisa hadir, maka bukti transfer bakal
                dijadiin tiket buat gabung di SESI 1 gelombang berikutnya{" "}
                <i>(sesuai waktu yang ditentukan)</i>.
              </li>
              <li>
              ...
              <li>
                course sesi 1 akan digelar via google meet dengan format 2 arah
                (<b>gue ngomong, kalian ngomong</b>{" "}
                <small>
